 ...
 * @author chauh
 */
public class EditFeesDetails extends javax.swing.JFrame {   //inline import
    ...
    public String UpdateData(){
        ...
        try {
            ...
            pst.setFloat(12, cgstAmount);
            pst.setFloat(13, sgstAmount);
    ...
    public void setRecords(){
        ...
        try {
            ...
            PreparedStatement pst = con.prepareStatement("Select * from fees_details order by reciept_no desc fetch first 1 rows only");
             ...
             reciept_txt.setText(rs.getString("reciept_no"));
             Received_txt.setText(rs.getString("student_name"));
             txt_rollNo.setText(rs.getString("roll_no"));
             Combo_mod.setSelectedItem(rs.getString("payment_mode"));
             chequeno_txt.setText(rs.getString("cheque_no"));
             bankname_txt.setText(rs.getString("bank_name"));
             DDno_txt.setText(rs.getString("dd_no"));
             coursename_txt.setText(rs.getString("course_name"));
             GSTno_lbl.setText(rs.getString("gstin"));
             total_txt.setText(rs.getString("total_amount"));
             datechooser.setDate(rs.getDate("date"));
             amount_txt.setText(rs.getString("amount"));
             cgst_txt.setText(rs.getString("cgst"));
            sgst_txt.setText(rs.getString("sgst"));
            txt_totalwords.setText(rs.getString("total_in_words"));
            txt_remark.setText(rs.getString("remark"));
            Year1_txt.setText(rs.getString("year1"));
            Year2_txt.setText(rs.getString("year2"));
